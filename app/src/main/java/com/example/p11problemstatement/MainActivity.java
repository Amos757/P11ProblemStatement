...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerItem[0] = new ObjectDrawerItem(R.drawable.info, "Bio");
        drawerItem[1] = new ObjectDrawerItem(R.drawable.injection, "Vaccination");
        drawerItem[2] = new ObjectDrawerItem(R.drawable.calendar, "Anniversary");
        drawerItem[3] = new ObjectDrawerItem(R.drawable.favourites, "About Us");


        ab = getSupportActionBar();

        drawerAdapter aa = new drawerAdapter(this , R.layout.row , drawerItem);
